...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  try {
    ...
    await pool.query(`UPDATE users SET profile_setup_done = true WHERE profile_setup_done IS NULL OR (profile_setup_done = false AND created_at < NOW() - INTERVAL '1 minute')`);
