...
async function discordEmbedMiddleware(req: Request, res: Response, next: NextFunction) {
  ...
  const RESERVED = new Set(["api", "auth", "objects", "shop", "login", "register", "dashboard", "team", "founders", "changes", "templates", "tos", "secret", "assets", "easter-event", "leaderboard", "status"]);
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/check-username", async (req, res) => {
    ...
    const RESERVED = ["api", "auth", "objects", "shop", "login", "register", "dashboard", "team", "founders", "changes", "templates", "tos", "secret", "assets", "hexed", "admin", "status", "leaderboard", "profile", "options", "miscellaneous", "extras", "markdowns", "wheelspin", "easter"];
